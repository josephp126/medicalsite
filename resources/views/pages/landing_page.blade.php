...
<div id="wrapper">
    ...
    <div class="container">
        ...
        <div class="col-lg-5">
            ...
            <a href="for-employers.html" class="btn-cta-outline-white mt-4">For Employers</a>
            </div>
        </div>
        <div class="col-lg-6 d-block d-lg-none mt-4">
            <img
    ...
    <div class="container">
        ...
        <div class="col-12 text-center">
            <a href="" class="tlink"
            ><span>See All</span>
            <img src="img/rt-arrow-blue.svg" class="ml-2" alt=""
            /></a>
        </div>
        </div>
    </div>
...
unsubscribe anytime and we won't share your information
    ...
    <div class="frow">
        ...
        <div class="row">
            <div
            class="col-12 d-lg-flex text-center justify-content-around align-items-center feat-img"
            >
